...
export const TestNative: FC<PropsTypes> = (props) => {
  const { words } = props;
  ...
  useEffect(() => {
    const newAnswers = [
      { key: currentIndex * 4, name: shuffledWords[currentIndex].value, isCorrect: true },
      ...getWrongAnswers(words, shuffledWords[currentIndex].id, currentIndex, "VALUE")
    ];
        ...
        {showResult ? (
          ...
          <>
            ...
            <div className="words-test-exercise">
              <div className="words-test-exercise__value">{shuffledWords[currentIndex].translate[myCurrentLang]}</div>
